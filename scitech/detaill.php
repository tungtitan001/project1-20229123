...
?>
    ...
    <section class="detail">
        <div class="container">
                    ...
                    <div class="detail-text-right">
                        <table>
                            ...
                            <tr>
                                ...
                                <?php
                                    $a = (int)$result['sanpham_gia']; $b = (int)$result['quantitys']; $TTA = $a*$b;
                                ?>
                            </tr>
                            <?php
            ...
            <br>
            <p style="text-align: center;">Mọi thắc mắc quý khách vui lòng liên hệ hotline <span  style="font-size: 20px; color: red;">0888 672 795 </span> hoặc chat với kênh hỗ trợ trên website để được hỗ trợ nhanh nhất.</p>
        </div>
    </section>
