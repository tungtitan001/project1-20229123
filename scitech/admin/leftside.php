...
<section class="admin-content row space-between">
        ...
        <div class="header-top-left">
            <a href="index.php"><p> <span>SCI</span>TECH</p></a>
        </div>
            <ul>
                <li><a  href="#"> <img style="width:20px" src="icon/hi.png" alt="">Chào: Admin <span style="color:blueviolet; font-size:22px"><?php echo Session::get('admin_name') ?></span><span style="color: red; font-size:20px">&#10084;</span></a>
                ...
                <li><a href="#"><img style="width:20px" src="icon/size.png" alt="">Kích thước</a>
                    <ul>
